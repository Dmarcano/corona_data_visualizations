...
function calculate_country_totals(data)
{
    ...
    for(let i = 0; i < labels.length; i++)
    {
        ...
        country_keys.forEach(country_key =>merge_providence_data(country_data, country_key, i, total_country_data))
    }
...
async function parse_time_series()
{
  ...
  time_series.totals = calculate_country_totals(time_series)
